...
jQuery(document).ready( function() {
        ...
        selection = selection.append('svg').style('width', '80%').style('height', '800px');
        ...
        function initTreemap() {
            ...
            grandparent.append('rect')
                    ...
                    .on('mouseout', function(){
                        d3.select(this).attr('fill', '#ec1b2d');
                    })
                    .on('mouseover', function(){
                        d3.select(this).attr('fill', '#ff253a');
                    });
            ...
            function leafClicked(d) {
                // Click on final leaf
                if( d.url && !d._children ) {
                    window.location = d.url;
                }
            }
            
            function leafPointer(d) {
                if( !d || (d.url || d._children ) ) {
                    return 'pointer';
                }
